...
var toggleForm = function(flag, elementNo, e){
    if(flag){
        if(elementNo!=undefined)
        {
            $("#target"+elementNo).css("display", "block");
        }
        $(e.target).addClass("btn-success");
        $(e.target).next().removeClass("btn-danger");
    }
    else {
        if(elementNo!=undefined)
        {
            $("#target"+elementNo).css("display", "none");
        }
        $(e.target).addClass("btn-danger");
        $(e.target).prev().removeClass("btn-success");
    }
};

var ShowHideDiv=function(objDivID,DivToShow,DivToHide)
{
    if(DivToShow!=undefined)
    $("#"+objDivID+DivToShow).css("display","block");
    if(DivToHide!=undefined)
    $("#"+objDivID+DivToHide).css("display","none");
