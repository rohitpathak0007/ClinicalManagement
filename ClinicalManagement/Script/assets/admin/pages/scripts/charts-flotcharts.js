var ChartsFlotcharts = function() {
    ...
    return {
        ...
        initCharts: function() {
			...
			//Added by Gulshan
			function chart2_1() {
				var tempSizeDiv=$('#chart_2_1').size();
                if ($('#chart_2_1').size() != 1) {
                    return;
                }
                ...
                var previousPoint = null;
                $("#chart_2_1").bind("plothover", function(event, pos, item) {
                    $("#x").text(pos.x.toFixed(2));
                    $("#y").text(pos.y.toFixed(2));
