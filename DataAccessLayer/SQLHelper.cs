...
namespace DataAccess
{
    ...
    {
        public static string ConnectionStringLocalTransaction = (ConfigurationManager.ConnectionStrings["Clinical_Connection"].ConnectionString);

        public SQLHelper(string ProgramId)
        {
        ...
        public static string ExecuteNonQueryOutputResult(string connectionString, CommandType cmdType, string cmdText, string strOuput, params SqlParameter[] commandParameters)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                PrepareCommand(cmd, conn, null, cmdType, cmdText, commandParameters);
                int val = cmd.ExecuteNonQuery();
                string strOutPut = cmd.Parameters[strOuput].Value.ToString();
                cmd.Parameters.Clear();
                return strOutPut;
